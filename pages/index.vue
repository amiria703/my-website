...
*/
const typeList = ref(["amiria703", "Amir Hossein Maher", "a Junior Web Developer", "a solo developer", "a Developix lover", "an open-source lover", "a programmer", "a Swiftie", "a music lover", "a student", "a boy"]);
